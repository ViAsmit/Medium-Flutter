...
class SignEmailScreen extends StatefulWidget {
  @override
  _SignEmailScreenState createState() => _SignEmailScreenState();
}

class _SignEmailScreenState extends State<SignEmailScreen> {
  @override
